...
//        }
    ...
    public class CBSPlanPath implements PlanPath {
        ...
        private static final HashSet<Integer>[][] visited = Main.visited;
        private static char[][] grid;  // 地图网格
        private static int gridSizeX;  // 网格大小X
        private static int gridSizeY;  // 网格大小Y
        ...
        public void plan(Frame frame) {
            ...
            for (Robot robot : robots) {
                ...
                visited[start.X()][start.Y()].add(frameNumber);
                if (robot.getState() == 0) {
//                    if (robot.hasPath() ) {//todo
//                        System.err.println("\u001B[33m"+"Boo!"+frameNumber);
//                        System.err.println(robot.getPathList());
//                        System.err.println("\u001B[33m"+robot.getId());
//                    }
            ...
            for (Robot robot : robots) {
                if (robot.isHasGoods()) {//前往港口
                    ...
                    if (isValidPosition(next.X(), next.Y(), 1)){
                        minDistance = mapPos[next.X()][next.Y()].bfsWeightsDistance;
                    }
                    ...
                    robot.nextPos = next;
//                    if (frameNumber<500) {//todo
//                        System.err.println("goback "+frameNumber );
//                        System.err.println(next);
//                        System.err.println(visited[next.X()][next.Y()]);
//                        System.err.println(robot.getId());
//                    }
                    visited[next.X()][next.Y()].add(frameNumber+1);
//                    if (frameNumber<500) {//todo
//                        System.err.println(visited[next.X()][next.Y()]);
//                    }
                }
    ...
    private static List<Pos> reconstructPath(Node currentNode, Node startNode) {
        ...
        //Pos cur = new Pos(currentNode.x,currentNode.y);
//        if (frameNumber<500) {//todo
//            System.err.println("recon  "+ frameNumber);
//            System.err.println(frameNumber+currentNode.g);
//            System.err.println(currentNode.x);
//            System.err.println(currentNode.y);
//        }
        while (currentNode != null && currentNode.parent != null) {
            visited[currentNode.x][currentNode.y].add(frameNumber + currentNode.g);
            //if (frameNumber<500)System.err.println(visited[currentNode.x][currentNode.y]);
...
//            System.err.println(currentNode.x);
//            System.err.println(currentNode.y);
//            System.err.println(visited[currentNode.x][currentNode.y]);
//        }
        // 反转路径，使其从起点到相交节点
        Collections.reverse(path);
        return path;
